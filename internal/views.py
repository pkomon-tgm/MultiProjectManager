...
def overview(request):
    ...
    return render(request, "internal/../projects/templates/projects/overview.html", {"projects": projects})
...
def project_detail(request, id):
    ...
    return render(request, "internal/../projects/templates/projects/detail_view.html", {"project": project})
